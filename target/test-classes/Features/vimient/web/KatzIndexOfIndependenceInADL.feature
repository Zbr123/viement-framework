Feature: Katz Index of Independence in ADL

  @vim-001 @Web
  Scenario: User is able to fill a new Katz Index of Independence in ADL for a senior(Testing Reset button)
    ...
    When    [Web Katz Index of Independence in ADL Page] User clicks on Reset button
  ...
  @vim-002 @Web
  Scenario: User is able to fill a new Katz Index of Independence in ADL for a senior(Testing Save button)
    Given   [Main Page] User go the web portal and navigate to the login page
    When    [Web Login Page] User enters email srijan-admin@srijan.net
    And     [Web Login Page] User enters password Srijan@12345
    And     [Web Login Page] User clicks on Log In button
  ...
  @vim-003 @Web
  Scenario: User is able to fill a new Katz Index of Independence in ADL for a senior(Testing Submit button)
    Given   [Main Page] User go the web portal and navigate to the login page
    When    [Web Login Page] User enters email srijan-admin@srijan.net
    And     [Web Login Page] User enters password Srijan@12345
    And     [Web Login Page] User clicks on Log In button
  ...
  @vim-004 @Web
  Scenario: User is able to fill a new Katz Index of Independence in ADL for a senior(Testing View feature)
    Given   [Main Page] User go the web portal and navigate to the login page
    ...
    Then    [Web Katz Index of Independence in ADL Page] User should see the Close button
    And     [Web Katz Index of Independence in ADL Page] User should see the Print button
    When    [Web Katz Index of Independence in ADL Page] User clicks on Close button