Feature: Add Senior
  ...
  Scenario: User is able to add senior
    ...
    And     [Web Add Senior Page] User enters in First Name inputbox Tannu
    ...
    And     [Web Add Senior Page] User enters in Date of Birth inputbox 05/16/1955
    And     [Web Add Senior Page] User enters in Email inputbox tannu.ahuja+automation
    ...
    And     [Web Add Senior Page] User enters in City inputbox San Diego
