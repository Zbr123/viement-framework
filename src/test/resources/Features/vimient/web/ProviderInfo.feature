Feature: Provider Info
  ...
  @vim-001 @Web
    ...
    When    [Web Provider Info SubTab Page] User enters practice name Doctor
    And     [Web Provider Info SubTab Page] User enters first name Zubair
    And     [Web Provider Info SubTab Page] User enters last name Dogar
